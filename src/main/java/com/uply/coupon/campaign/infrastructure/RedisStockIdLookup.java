 ...
 *
 * <p>쿠폰 발행 로직 전, stockId 조회 단계에서 발생할 수 있는 DB Connection Pool 고갈을 방지 @Primary - StockIdLookup 인터페이스
 * 구현체가 여러 개 존재할 때, Spring DI 컨테이너가 최우선으로 주입하도록 지정 (우선 이렇게 설정해놓음)
 */
@Primary
@Component

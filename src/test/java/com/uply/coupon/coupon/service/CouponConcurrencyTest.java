...
class CouponConcurrencyTest {
    ...
    class SyncDbStrategyConcurrencyTest {
        ...
        void setUp() {
            ...
            CampaignStock stock = campaignStockRepository.save(
            ...
            for (long userId = 1; userId <= totalRequests; userId++) {
                ...
                executorService.submit(() -> {
                    try {
                        ...
                        CouponIssueRequest request = new CouponIssueRequest(currentUserId, campaignId, routeId, fareClass);
...
//            assertThat(redisTemplate.opsForSet().size("issued:" + campaignId)).isEqualTo(10L);
            ...
            long failureCount = exceptions.stream()
                    .filter(e -> e instanceof PessimisticLockingFailureException
    ...
    class KafkaStrategyConcurrencyTest {
        ...
        void issueCoupon_Kafka_Concurrency_Success() throws InterruptedException {
            ...
            then(kafkaTemplate).should(times(10))
